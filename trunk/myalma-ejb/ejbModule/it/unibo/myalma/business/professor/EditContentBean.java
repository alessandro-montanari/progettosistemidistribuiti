...
public class EditContentBean implements IEditContent, Serializable
{
	...
	public void save() 
	{
		...
		else if(content.getParentContent().getId() != parentContent.getId())
		{
			...
			// Devo clonare il contenuto perchŽ siccome ho orphanRemoval = true quando invoco profManager.removeContent(content),
			...
			// non viene inserito nel DB ovviamente, quindi avrˆ id = -1 e non  associato a nessun albero parent e root = null,  quindi un 
			// contenuto libero
